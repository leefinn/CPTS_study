...
```shell-session
xF1NN@htb[/htb]$ cat /etc/samba/smb.conf | grep -v "#\|\;" 
...
```shell-session
xF1NN@htb[/htb]$ smbclient //10.129.14.128/notes
...
```shell-session
xF1NN@htb[/htb]$ rpcclient -U "" 10.129.14.128
...
```shell-session
xF1NN@htb[/htb]$ for i in $(seq 500 1100);do rpcclient -N -U "" 10.129.14.128 -c "queryuser 0x$(printf '%x\n' $i)" | grep "User Name\|user_rid\|group_rid" && echo "";done
...
```shell-session
xF1NN@htb[/htb]$ samrdump.py 10.129.14.128
...
```shell-session
xF1NN@htb[/htb]$ crackmapexec smb 10.129.14.128 --shares -u '' -p ''
...
```shell-session
xF1NN@htb[/htb]$ git clone https://github.com/cddmp/enum4linux-ng.git
xF1NN@htb[/htb]$ cd enum4linux-ng
...
```shell-session
xF1NN@htb[/htb]$ ./enum4linux-ng.py 10.129.14.128 -A
