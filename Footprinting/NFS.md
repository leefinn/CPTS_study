...
```shell-session
xF1NN@htb[/htb]$ sudo nmap 10.129.14.128 -p111,2049 -sV -sC
...
```shell-session
xF1NN@htb[/htb]$ sudo nmap --script nfs* 10.129.14.128 -sV -p111,2049
...
```shell-session
xF1NN@htb[/htb]$ showmount -e 10.129.14.128
...
```shell-session
xF1NN@htb[/htb]$ mkdir target-NFS
xF1NN@htb[/htb]$ sudo mount -t nfs 10.129.14.128:/ ./target-NFS/ -o nolock
xF1NN@htb[/htb]$ cd target-NFS
xF1NN@htb[/htb]$ tree .
...
```shell-session
xF1NN@htb[/htb]$ cd ..
xF1NN@htb[/htb]$ sudo umount ./target-NFS
```