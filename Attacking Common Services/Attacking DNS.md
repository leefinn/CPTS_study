...
```shell-session
xF1NN@htb[/htb]# nmap -p53 -Pn -sV -sC 10.10.110.213
...
```shell-session
xF1NN@htb[/htb]# dig AXFR @ns1.inlanefreight.htb inlanefreight.htb
...
```shell-session
xF1NN@htb[/htb]# fierce --domain zonetransfer.me
...
```shell-session
xF1NN@htb[/htb]# ./subfinder -d inlanefreight.com -v       
...
```shell-session
xF1NN@htb[/htb]$ git clone https://github.com/TheRook/subbrute.git >> /dev/null 2>&1
xF1NN@htb[/htb]$ cd subbrute
xF1NN@htb[/htb]$ echo "ns1.inlanefreight.com" > ./resolvers.txt
xF1NN@htb[/htb]$ ./subbrute.py inlanefreight.com -s ./names.txt -r ./resolvers.txt
...
```shell-session
xF1NN@htb[/htb]# host support.inlanefreight.com
...
```shell-session
xF1NN@htb[/htb]# cat /etc/ettercap/etter.dns
