...
```shell-session
xF1NN@htb[/htb]$ nmap -Pn -sV -sC -p1433 10.10.10.125
...
```shell-session
xF1NN@htb[/htb]$ mysql -u julio -pPassword123 -h 10.129.20.13
...
```shell-session
xF1NN@htb[/htb]$ sqsh -S 10.129.203.7 -U julio -P 'MyPassword!' -h
...
```shell-session
xF1NN@htb[/htb]$ mssqlclient.py -p 1433 julio@10.129.203.7 
...
```shell-session
xF1NN@htb[/htb]$ sudo responder -I tun0
...
```shell-session
xF1NN@htb[/htb]$ sudo impacket-smbserver share ./ -smb2support
