...
![Decoder tab showing encoded string and its decoded JSON output with options for text, hex, and smart decode.](https://academy.hackthebox.com/storage/modules/110/burp_b64_decode.jpg)
...
![Request and response details with encoded IP in request, HTML response, and Inspector showing URL and Base64 decoding.](https://academy.hackthebox.com/storage/modules/110/burp_inspector.jpg)

In ZAP, we can use the `Encoder/Decoder/Hash` tool, which will automatically decode strings using various decoders in the `Decode` tab: ![Text encoding/decoding interface showing Base64 encoded string and its decoded JSON output.](https://academy.hackthebox.com/storage/modules/110/zap_b64_decode.jpg)
...
![Decoder tab showing JSON with admin access and its Base64 encoded string, with options for text, hex, and smart decode.](https://academy.hackthebox.com/storage/modules/110/burp_b64_encode.jpg)

![Text encoding interface showing JSON with admin access and its Base64 encoded output.](https://academy.hackthebox.com/storage/modules/110/zap_b64_encode.jpg)
