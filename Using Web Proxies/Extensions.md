...
![BApp Store showing Burp extensions. Active Scan++ highlighted, last updated 25 Mar 2021. Features include host header attacks, edge side includes, XML input handling.](https://academy.hackthebox.com/storage/modules/110/burp_bapp_store.jpg)
...
![BApp Store showing Burp extensions. Decoder Improved installed, last updated 19 Feb 2021. Features include encoding, decoding, hashing, tabs, Unicode support, and hex editor.](https://academy.hackthebox.com/storage/modules/110/burp_extension.jpg)
...
![Decoder Improved interface showing 'HTB Academy' text, hex view, and options for hashing with MD5 and encoding as plain text.](https://academy.hackthebox.com/storage/modules/110/burp_extension_decoder_improved.jpg)
...
![Toolbar with 'Standard Mode' selected, 'Sites' section, and 'Manage Add-ons' button highlighted.](https://academy.hackthebox.com/storage/modules/110/zap_marketplace_button.jpg)

In this tab, we can see the different available add-ons for ZAP. Some add-ons may be in their `Release` build, meaning that they should be stable to be used, while others are in their `Beta/Alpha` builds, which means that they may experience some issues in their use. Let's try installing the `FuzzDB Files` and `FuzzDB Offensive` add-ons, which adds new wordlists to be used in ZAP's fuzzer: ![Marketplace tab showing add-ons. Selected: FuzzDB Files and FuzzDB Offensive, both in Release status. Options to install or get more info.](https://academy.hackthebox.com/storage/modules/110/zap_fuzzdb_install.jpg)
...
![File Fuzzers type selected. Files listed with 'command_execution-unix.txt' checked. Payloads preview shows command execution examples.](https://academy.hackthebox.com/storage/modules/110/zap_fuzzdb_cmd_exec.jpg)
...
![Fuzzer progress at 62% on http://139.59.6.56:31133/ping. Messages sent: 34, Errors: 8. Task IDs with status 200 OK, showing payloads like ';id' and '/usr/bin/id'.](https://academy.hackthebox.com/storage/modules/110/zap_fuzzer_cmd_inj.jpg)
