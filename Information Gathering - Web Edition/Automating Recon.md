...
```shell-session
xF1NN@htb[/htb]$ git clone https://github.com/thewhiteh4t/FinalRecon.git
xF1NN@htb[/htb]$ cd FinalRecon
xF1NN@htb[/htb]$ pip3 install -r requirements.txt
xF1NN@htb[/htb]$ chmod +x ./finalrecon.py
xF1NN@htb[/htb]$ ./finalrecon.py --help
...
```shell-session
xF1NN@htb[/htb]$ ./finalrecon.py --headers --whois --url http://inlanefreight.com
