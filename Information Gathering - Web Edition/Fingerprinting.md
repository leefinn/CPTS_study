...
```shell-session
xF1NN@htb[/htb]$ curl -I inlanefreight.com
```
...
```shell-session
xF1NN@htb[/htb]$ curl -I https://inlanefreight.com
...
```shell-session
xF1NN@htb[/htb]$ curl -I https://www.inlanefreight.com
...
```shell-session
xF1NN@htb[/htb]$ pip3 install git+https://github.com/EnableSecurity/wafw00f
```
...
```shell-session
xF1NN@htb[/htb]$ wafw00f inlanefreight.com
...
```shell-session
xF1NN@htb[/htb]$ sudo apt update && sudo apt install -y perl
xF1NN@htb[/htb]$ git clone https://github.com/sullo/nikto
xF1NN@htb[/htb]$ cd nikto/program
xF1NN@htb[/htb]$ chmod +x ./nikto.pl
```
...
```shell-session
xF1NN@htb[/htb]$ nikto -h inlanefreight.com -Tuning b
```
