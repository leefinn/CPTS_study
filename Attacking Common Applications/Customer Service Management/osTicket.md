...
![Support Center page with options to open a new ticket and check ticket status, server details, and response code 200.](https://academy.hackthebox.com/storage/modules/113/osticket_eyewitness.png)
...
![Support Center page with options to open a new ticket and check ticket status, welcoming users to the support system.](https://academy.hackthebox.com/storage/modules/113/osticket_main.png)
...
![Support Center page for opening a new ticket with fields for contact information, help topic 'Feedback', and issue summary 'Your site is slow'.](https://academy.hackthebox.com/storage/modules/113/new_ticket.png)

This is a modified version of osTicket as an example, but we can see that an email address was provided.

   

![Support Center confirmation page showing 'Support ticket request created' with ticket ID 940288 and email for additional information.](https://academy.hackthebox.com/storage/modules/113/ticket_email.png)
...
![Support Center ticket view showing ticket ID 940288, status open, issue 'Your site is slow', and a reply section.](https://academy.hackthebox.com/storage/modules/113/ost_tickets.png)
...
```shell-session
xF1NN@htb[/htb]$ sudo python3 dehashed.py -q inlanefreight.local -p
...
```shell-session
xF1NN@htb[/htb]$ cat ilfreight_subdomains
...
![osTicket login page requiring email or username and password for authentication.](https://academy.hackthebox.com/storage/modules/113/osticket_admin.png)
...
![osTicket dashboard showing open tickets tab with no results, and options for viewing, searching, and creating tickets.](https://academy.hackthebox.com/storage/modules/113/osticket_kevin.png)
...
![Support ticket conversation with Charles Smithson requesting password reset due to VPN issues, Kevin Grimes providing reset instructions, and follow-up replies confirming resolution.](https://academy.hackthebox.com/storage/modules/113/osticket_ticket.png)
...
![Attacking_Common_Applications_Walkthrough_Image_49.png](https://academy.hackthebox.com/storage/walkthroughs/39/Attacking_Common_Applications_Walkthrough_Image_49.png)

![Attacking_Common_Applications_Walkthrough_Image_50.png](https://academy.hackthebox.com/storage/walkthroughs/39/Attacking_Common_Applications_Walkthrough_Image_50.png)

Once logged in, students need to click on "Closed" and then navigate to the only closed ticket available:

![Attacking_Common_Applications_Walkthrough_Image_51.png](https://academy.hackthebox.com/storage/walkthroughs/39/Attacking_Common_Applications_Walkthrough_Image_51.png)
...
![Attacking_Common_Applications_Walkthrough_Image_52.png](https://academy.hackthebox.com/storage/walkthroughs/39/Attacking_Common_Applications_Walkthrough_Image_52.png)
