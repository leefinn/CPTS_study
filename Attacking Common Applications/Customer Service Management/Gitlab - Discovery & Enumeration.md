...
![GitLab sign-up restrictions page with options for enabling sign-up, requiring admin approval, setting minimum password length, and specifying allowed and denied domains.](https://academy.hackthebox.com/storage/modules/113/gitlab_signup_res.png)
...
![GitLab sign-in restrictions page with options for password authentication, two-factor authentication, email notifications for unknown sign-ins, and settings for homepage URL and sign-out path.](https://academy.hackthebox.com/storage/modules/113/gitlab_2fa.png)
...
![GitLab login page with fields for username or email and password, and a sign-in button.](https://academy.hackthebox.com/storage/modules/113/gitlab_login.png)
...
![GitLab Explore page showing projects, groups, and snippets with a project by Administrator titled 'Inlanefreight dev'.](https://academy.hackthebox.com/storage/modules/113/gitlab_explore.png)
...
![GitLab project overview for 'Inlanefreight dev' showing 44 commits, 1 branch, and a list of files with last commit messages.](https://academy.hackthebox.com/storage/modules/113/gitlab_example.png)
...
![GitLab registration page with fields for first name, last name, username, email, and password, alongside a description of GitLab as a complete DevOps platform.](https://academy.hackthebox.com/storage/modules/113/gitlab_signup.png)
...
![GitLab registration page with fields for first name, last name, username, email, and password. Error message: 'Username is already taken' for 'root'.](https://academy.hackthebox.com/storage/modules/113/gitlab_taken2.png)
...
![GitLab project overview for 'Inlanefreight website' with 22 commits, 1 branch, and a list of files. Warning: 'Add SSH key' to pull or push via SSH.](https://academy.hackthebox.com/storage/modules/113/gitlab_internal.png)
