...
![Login form with fields for username, password, 'Remember Me' checkbox, and 'Forgot Your Password?' link.](https://academy.hackthebox.com/storage/modules/113/mass_assignment/pending.png)
...
![Intercepted HTTP POST request to /register with username and password parameters.](https://academy.hackthebox.com/storage/modules/113/mass_assignment/mass_hidden.png)

We can now try to log in to the application using the `new:test` credentials.

![3D arrows labeled Profit, Risk, and Loss intersecting.](https://academy.hackthebox.com/storage/modules/113/mass_assignment/loggedin.png)
...
![Attacking_Common_Applications_Walkthrough_Image_102.png](https://academy.hackthebox.com/storage/walkthroughs/39/Attacking_Common_Applications_Walkthrough_Image_102.png)
