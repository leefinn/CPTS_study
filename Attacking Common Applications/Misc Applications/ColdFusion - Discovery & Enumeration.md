...
```shell-session
xF1NN@htb[/htb]$ nmap -p- -sC -Pn 10.129.247.30 --open
...
![Directory listing of root with folders CFIDE and cfdocs.](https://academy.hackthebox.com/storage/modules/113/coldfusion/CFindex.png)

![Web page displaying directory listing of /CFIDE/ with files and folders such as Application.cfm, adminapi/, and install.cfm, accessed via IP 10.129.247.30:8500.](https://academy.hackthebox.com/storage/modules/113/coldfusion/CFIDE.png)

![Error page showing 'Invalid request of Application.cfm' with debugging information and resources for ColdFusion error resolution.](https://academy.hackthebox.com/storage/modules/113/coldfusion/CFError.png)
...
![ColdFusion Administrator login screen with fields for username and password.](https://academy.hackthebox.com/storage/modules/113/coldfusion/CF8.png)
