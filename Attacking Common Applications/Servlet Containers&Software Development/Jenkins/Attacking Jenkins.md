...
![Jenkins Script Console with Groovy script to execute 'id' command, showing result as 'uid=0(root) gid=0(root)'.](https://academy.hackthebox.com/storage/modules/113/groovy_web.png)
