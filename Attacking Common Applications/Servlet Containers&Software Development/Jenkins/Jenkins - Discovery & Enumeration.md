...
![Jenkins Configure Global Security page showing authentication and security realm options, with 'Jenkins’ own user database' and 'Logged-in users can do anything' selected.](https://academy.hackthebox.com/storage/modules/113/jenkins_global_security.png)
...
![Jenkins login page with fields for username and password, and 'Keep me signed in' option.](https://academy.hackthebox.com/storage/modules/113/jenkins_login.png)
