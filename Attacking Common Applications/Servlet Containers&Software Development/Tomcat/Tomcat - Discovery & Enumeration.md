...
![HTTP 404 error page from Apache Tomcat 9.0.30, indicating 'Not Found' with message '/invalid' and description about missing resource.](https://academy.hackthebox.com/storage/modules/113/tomcat_invalid.png)
...
```shell-session
xF1NN@htb[/htb]$ curl -s http://app-dev.inlanefreight.local:8080/docs/ | grep Tomcat 
...
```shell-session
xF1NN@htb[/htb]$ gobuster dir -u http://web01.inlanefreight.local:8180/ -w /usr/share/dirbuster/wordlists/directory-list-2.3-small.txt 
