...
![WordPress login page with fields for username, password, and options to remember login or recover password.](https://academy.hackthebox.com/storage/modules/113/wp-login2.png)
...
```shell-session
xF1NN@htb[/htb]$ curl -s http://blog.inlanefreight.local | grep WordPress
...
```shell-session
xF1NN@htb[/htb]$ curl -s http://blog.inlanefreight.local/ | grep themes
...
```shell-session
xF1NN@htb[/htb]$ curl -s http://blog.inlanefreight.local/ | grep plugins
...
```shell-session
xF1NN@htb[/htb]$ curl -s http://blog.inlanefreight.local/?p=1 | grep plugins
...
![WordPress login page with error message: 'The password for username admin is incorrect.'](https://academy.hackthebox.com/storage/modules/113/valid_user.png)

However, an invalid username returns that the user was not found.

   

![WordPress login page with error message: 'The username someone is not registered on this site.'](https://academy.hackthebox.com/storage/modules/113/invalid_user.png)
...
```shell-session
xF1NN@htb[/htb]$ sudo gem install wpscan
```
...
```shell-session
xF1NN@htb[/htb]$ sudo wpscan --url http://blog.inlanefreight.local --enumerate --api-token dEOFB<SNIP>
...
![Attacking_Common_Applications_Walkthrough_Image_2.png](https://academy.hackthebox.com/storage/walkthroughs/39/Attacking_Common_Applications_Walkthrough_Image_2.png)
...
![Attacking_Common_Applications_Walkthrough_Image_3.png](https://academy.hackthebox.com/storage/walkthroughs/39/Attacking_Common_Applications_Walkthrough_Image_3.png)

Within the redirected web page, students will see that the "WP Sitemap Page" plugin is used:

![Attacking_Common_Applications_Walkthrough_Image_4.png](https://academy.hackthebox.com/storage/walkthroughs/39/Attacking_Common_Applications_Walkthrough_Image_4.png)
...
![Attacking_Common_Applications_Walkthrough_Image_5.png](https://academy.hackthebox.com/storage/walkthroughs/39/Attacking_Common_Applications_Walkthrough_Image_5.png)
