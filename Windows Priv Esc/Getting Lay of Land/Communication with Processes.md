...
C:\tools\AccessChk>tasklist /FI "PID eq 2064"

Image Name                     PID Session Name        Session#    Mem Usage
========================= ======== ================ =========== ============
**FileZilla Server**.exe          2064 Services                   0     11,084 K

+ ### Which account has WRITE_DAC privileges over the \pipe\SQLLocal\SQLEXPRESS01 named pipe?

C:\tools\AccessChk>accesschk.exe /accepteula -w \pipe\SQLLocal\SQLEXPRESS01 -v
...
\\.\Pipe\SQLLocal\SQLEXPRESS01
  Medium Mandatory Level (Default) [No-Write-Up]
  RW **NT SERVICE\MSSQL$SQLEXPRESS0**1
