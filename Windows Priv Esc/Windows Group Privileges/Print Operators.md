...
![Command prompt running as NT AUTHORITY\SYSTEM. PowerShell shows Capcom.sys driver identified and ExploitCapcom.exe executed, resulting in successful token stealing and SYSTEM shell launch.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/67/capcomexploit.png)
