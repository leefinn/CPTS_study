...
![Windows User Rights Assignment showing 'Debug programs' assigned to Administrators group under Local Policies.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/67/debug.png)
...
![Windows Task Manager showing lsass.exe process selected. Context menu open with 'Create dump file' option highlighted.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/67/WPE_taskmgr_lsass.png)
...
![PowerShell window running script to start cmd.exe as NT AUTHORITY\SYSTEM. Command prompt shows successful execution with SYSTEM privileges.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/67/psgetsys_winlogon.png)
...
![PowerShell script running to start cmd.exe as NT AUTHORITY\SYSTEM. Command prompt confirms execution with SYSTEM privileges.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/67/psgetsys_lsass.png)
