...
xF1NN@htb[/htb]$ wget https://files.pythonhosted.org/packages/28/84/27df240f3f8f52511965979aad7c7b77606f8fe41d4c90f2449e02172bb1/setuptools-2.0.tar.gz
xF1NN@htb[/htb]$ tar -xf setuptools-2.0.tar.gz
xF1NN@htb[/htb]$ cd setuptools-2.0/
xF1NN@htb[/htb]$ python2.7 setup.py install

xF1NN@htb[/htb]$ wget https://files.pythonhosted.org/packages/42/85/25caf967c2d496067489e0bb32df069a8361e1fd96a7e9f35408e56b3aab/xlrd-1.0.0.tar.gz
xF1NN@htb[/htb]$ tar -xf xlrd-1.0.0.tar.gz
xF1NN@htb[/htb]$ cd xlrd-1.0.0/
xF1NN@htb[/htb]$ python2.7 setup.py install
```
...
```shell-session
xF1NN@htb[/htb]$ python2.7 windows-exploit-suggester.py --update
```
...
```shell-session
xF1NN@htb[/htb]$ python2.7 windows-exploit-suggester.py  --database 2021-05-13-mssb.xls --systeminfo win7lpe-systeminfo.txt 
