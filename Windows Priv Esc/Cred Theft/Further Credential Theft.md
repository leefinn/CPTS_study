...
![Remote Desktop Connection window showing Computer: SQL01 and User name: inlanefreight\bob. Options to edit or delete saved credentials. Connect and Help buttons visible.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/67/cmdkey_rdp.png)
...
```shell-session
xF1NN@htb[/htb]$ python2.7 keepass2john.py ILFREIGHT_Help_Desk.kdbx 
...
```shell-session
xF1NN@htb[/htb]$ hashcat -m 13400 keepass_hash /opt/useful/seclists/Passwords/Leaked-Databases/rockyou.txt
...
Found with .\SharpChrome.exe logins /unprotect
...
SharpChrome completed in 00:00:00.5615024
