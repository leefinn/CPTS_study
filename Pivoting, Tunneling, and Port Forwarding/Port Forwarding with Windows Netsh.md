...
![Diagram showing an RDP request from Attack Host (10.10.15.5) to Windows Server (172.16.5.25) via Windows10 User (10.129.15.150) using Netsh.exe. The request listens on port 8080 and forwards to port 3389.](https://academy.hackthebox.com/storage/modules/158/88.png)
...
![Terminal showing xfreerdp command connecting to 10.129.42.198:8080 with user 'victor' and password 'pass@123'. Below, a Windows Command Prompt displays IP configuration for Ethernet adapter, showing IPv4 address 172.16.5.19.](https://academy.hackthebox.com/storage/modules/158/netsh_pivot.png)
