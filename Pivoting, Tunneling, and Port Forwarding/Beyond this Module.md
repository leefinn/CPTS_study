...
![GIF showcasing Starting-Point on HackTheBox Labs.](https://academy.hackthebox.com/storage/modules/158/startingpoint.gif)
...
![GIF showcasing the machines (boxes) on HackTheBox Labs.](https://academy.hackthebox.com/storage/modules/158/htbboxes.gif)
...
For an extreme challenge that may take you a while to get through, check out the [Ascension](https://app.hackthebox.com/prolabs/overview/ascension) Mini Pro Lab. This lab features two different AD domains and has plenty of chances to practice our AD enumeration and attacking skills.

![Ascension lab interface on Hack The Box showing entry point 10.13.38.20, progress tracker, and introduction text about Daedalus Airlines. Includes options for lab reset, downloading writeup, and certification details.](https://academy.hackthebox.com/storage/modules/158/ascension.png)
