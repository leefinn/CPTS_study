...
```shell-session
xF1NN@htb[/htb]$ sudo -u user /bin/echo Hello World!
...
```shell-session
xF1NN@htb[/htb]$ vim id_rsa
xF1NN@htb[/htb]$ chmod 600 id_rsa
xF1NN@htb[/htb]$ ssh root@10.10.10.10 -i id_rsa
...
```shell-session
xF1NN@htb[/htb]$ ssh-keygen -f key
...
```shell-session
xF1NN@htb[/htb]$ ssh root@10.10.10.10 -i key
