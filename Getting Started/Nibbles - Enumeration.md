...
```shell-session
xF1NN@htb[/htb]$ nmap -sV --open -oA nibbles_initial_scan 10.129.42.190
...
```shell-session
xF1NN@htb[/htb]$ nc -nv 10.129.42.190 22
...
```shell-session
xF1NN@htb[/htb]$ nc -nv 10.129.42.190 80
...
```shell-session
xF1NN@htb[/htb]$ nmap -sC -p 22,80 -oA nibbles_script_scan 10.129.42.190
...
```shell-session
xF1NN@htb[/htb]$ nmap -sV --script=http-enum -oA nibbles_nmap_http_enum 10.129.42.190 
