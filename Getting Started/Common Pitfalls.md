...
```shell-session
xF1NN@htb[/htb]$ sudo openvpn ./htb.ovpn
...
```shell-session
xF1NN@htb[/htb]$ ip -4 a show tun0
...
```shell-session
xF1NN@htb[/htb]$ ping -c 4 10.10.14.1
