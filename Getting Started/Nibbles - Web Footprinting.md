...
```shell-session
xF1NN@htb[/htb]$ whatweb 10.129.42.190
...
```shell-session
xF1NN@htb[/htb]$ curl http://10.129.42.190
...
```shell-session
xF1NN@htb[/htb]$ whatweb http://10.129.42.190/nibbleblog
...
```shell-session
xF1NN@htb[/htb]$ gobuster dir -u http://10.129.42.190/nibbleblog/ --wordlist /usr/share/seclists/Discovery/Web-Content/common.txt
...
```shell-session
xF1NN@htb[/htb]$ curl http://10.129.42.190/nibbleblog/README
...
```shell-session
xF1NN@htb[/htb]$ curl -s http://10.129.42.190/nibbleblog/content/private/users.xml | xmllint  --format -
...
```shell-session
xF1NN@htb[/htb]$ gobuster dir -u http://10.129.42.190/ --wordlist /usr/share/seclists/Discovery/Web-Content/common.txt
...
```shell-session
xF1NN@htb[/htb]$ curl -s http://10.129.42.190/nibbleblog/content/private/config.xml | xmllint --format -
