...
```shell-session
xF1NN@htb[/htb]$ nmap 10.129.42.253
...
```shell-session
xF1NN@htb[/htb]$ nmap -sV -sC -p- 10.129.42.253
...
```shell-session
xF1NN@htb[/htb]$ locate scripts/citrix
...
```shell-session
xF1NN@htb[/htb]$ nc -nv 10.129.42.253 21
...
```shell-session
xF1NN@htb[/htb]$ nmap -sC -sV -p21 10.129.42.253
...
```shell-session
xF1NN@htb[/htb]$ ftp -p 10.129.42.253
...
```shell-session
xF1NN@htb[/htb]$ nmap --script smb-os-discovery.nse -p445 10.10.10.40
...
```shell-session
xF1NN@htb[/htb]$ nmap -A -p445 10.129.42.253
...
```shell-session
xF1NN@htb[/htb]$ smbclient -N -L \\\\10.129.42.253
...
```shell-session
xF1NN@htb[/htb]$ smbclient \\\\10.129.42.253\\users
...
```shell-session
xF1NN@htb[/htb]$ smbclient -U bob \\\\10.129.42.253\\users
...
```shell-session
xF1NN@htb[/htb]$ snmpwalk -v 2c -c public 10.129.42.253 1.3.6.1.2.1.1.5.0
...
```shell-session
xF1NN@htb[/htb]$ snmpwalk -v 2c -c private  10.129.42.253 
...
```shell-session
xF1NN@htb[/htb]$ onesixtyone -c dict.txt 10.129.42.254
...
                                                             US Academy 3                                                             US Academy 4                                                             US Academy 2                                                             EU Academy 6                                                             US Academy 6                                                             US Academy 5                                                             EU Academy 4                                                             EU Academy 3                                                             EU Academy 1                                                             US Academy 1                                                             EU Academy 5                                                             EU Academy 2                                                     
...
Connected to htb-49cnkrljo6:1 (htb-ac-1631704)
...
Target(s): 10.129.187.85 (ACADEMY-GETSTART-SVCSCAN)   

Life Left: 112 minute(s)  Terminate 
...
 [Previous](https://academy.hackthebox.com/module/77/section/847)

[Next](https://academy.hackthebox.com/module/77/section/728) 

 Cheat Sheet [Go to Questions](https://academy.hackthebox.com/module/77/section/726#questionsDiv)
