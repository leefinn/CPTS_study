...
```shell-session
xF1NN@htb[/htb]$ ping 192.168.86.39 
...
```shell-session
xF1NN@htb[/htb]$ sudo nmap -v -O 192.168.86.39
...
```shell-session
xF1NN@htb[/htb]$ sudo nmap -v 192.168.86.39 --script banner.nse
...
```shell-session
xF1NN@htb[/htb]$ nmap -v -A 10.129.201.97
