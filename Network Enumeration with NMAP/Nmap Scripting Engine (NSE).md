...
```shell-session
xF1NN@htb[/htb]$ sudo nmap <target> -sC
```
...
```shell-session
xF1NN@htb[/htb]$ sudo nmap <target> --script <category>
```
...
```shell-session
xF1NN@htb[/htb]$ sudo nmap <target> --script <script-name>,<script-name>,...
```
...
```shell-session
xF1NN@htb[/htb]$ sudo nmap 10.129.2.28 -p 25 --script banner,smtp-commands
...
```shell-session
xF1NN@htb[/htb]$ sudo nmap 10.129.2.28 -p 80 -A
...
```shell-session
xF1NN@htb[/htb]$ sudo nmap 10.129.2.28 -p 80 -sV --script vuln 
