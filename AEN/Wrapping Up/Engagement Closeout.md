...
![Email from Bryan Robinson about completed external penetration test for Inlanefreight, listing vulnerabilities like command injection and weak passwords.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/163/end_testing.png)
