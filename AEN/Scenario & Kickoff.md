...
![Email from Bryan Robinson to Sarah McDonald about the start of an external penetration test for Inlanefreight. Testing traffic from IP 10.10.14.15. Secondary contact: John Lee, Principal Security Consultant. Includes contact details and testing procedure overview.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/163/start_testing.png)
