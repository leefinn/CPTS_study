...
```shell-session
xF1NN@htb[/htb]$ sudo service postgresql status
...
```shell-session
xF1NN@htb[/htb]$ sudo systemctl start postgresql
```
...
```shell-session
xF1NN@htb[/htb]$ sudo msfdb status
...
```shell-session
xF1NN@htb[/htb]$ msfdb reinit
xF1NN@htb[/htb]$ cp /usr/share/metasploit-framework/config/database.yml ~/.msf4/
xF1NN@htb[/htb]$ sudo service postgresql restart
