...
```shell-session
xF1NN@htb[/htb]$ ls /usr/share/metasploit-framework/modules
...
```shell-session
xF1NN@htb[/htb]$ ls /usr/share/metasploit-framework/scripts/
...
```shell-session
xF1NN@htb[/htb]$ ls /usr/share/metasploit-framework/tools/
