...
```shell-session
xF1NN@htb[/htb]$ searchsploit nagios3
...
```shell-session
xF1NN@htb[/htb]$ searchsploit -t Nagios3 --exclude=".py"
...
```shell-session
xF1NN@htb[/htb]$ ls /usr/share/metasploit-framework/
...
```shell-session
xF1NN@htb[/htb]$ cp ~/Downloads/9861.rb /usr/share/metasploit-framework/modules/exploits/unix/webapp/nagios3_command_injection.rb
xF1NN@htb[/htb]$ msfconsole -m /usr/share/metasploit-framework/modules/
```
...
```shell-session
xF1NN@htb[/htb]$ ls /usr/share/metasploit-framework/modules/exploits/linux/http/ | grep bludit
...
```shell-session
xF1NN@htb[/htb]$ cp ~/Downloads/48746.rb /usr/share/metasploit-framework/modules/exploits/linux/http/bludit_auth_bruteforce_mitigation_bypass.rb
```
