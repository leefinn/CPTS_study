...
```shell-session
xF1NN@htb[/htb]$ ls /usr/share/metasploit-framework/plugins
...
```shell-session
xF1NN@htb[/htb]$ git clone https://github.com/darkoperator/Metasploit-Plugins
xF1NN@htb[/htb]$ ls Metasploit-Plugins
...
```shell-session
xF1NN@htb[/htb]$ sudo cp ./Metasploit-Plugins/pentest.rb /usr/share/metasploit-framework/plugins/pentest.rb
```
